...
config = load(
    Merge(
        Source(file=SOURCES_DIR / "advanced_env_expansion_merge_default.yaml"),  # uses global "default"
        Source(file=SOURCES_DIR / "advanced_env_expansion_merge_empty.yaml", expand_env_vars="empty"),
        Source(file=SOURCES_DIR / "advanced_env_expansion_merge_disabled.yaml", expand_env_vars="disabled"),
