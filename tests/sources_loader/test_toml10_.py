...
class TestToml10Loader:
    ...
    def test_comprehensive_type_conversion(self, all_types_toml10_file: Path):
        ...
        result = load(LoadMetadata(file_=str(all_types_toml10_file), loader=Toml10Loader), AllPythonTypesCompact)
    ...
    def test_toml_with_prefix(self, prefixed_toml_file: Path):
        ...
        result = load(
            LoadMetadata(file_=str(prefixed_toml_file), loader=Toml10Loader, prefix="app"),
            PrefixedConfig,
        )
    ...
    def test_toml_env_var_substitution(self, tmp_path: Path, monkeypatch):
        ...
        result = load(LoadMetadata(file_=str(toml_file), loader=Toml10Loader), Config)
