...
class TestToml10Loader:
    ...
    def test_comprehensive_type_conversion(self, all_types_toml10_file: Path):
        ...
        result = load(Source(file=all_types_toml10_file, loader=Toml10Loader), schema=AllPythonTypesCompact)
    ...
    def test_toml_env_var_substitution(self, tmp_path: Path, monkeypatch):
        ...
        result = load(Source(file=toml_file, loader=Toml10Loader), schema=Config)
    ...
    def test_bool_in_int_field_raises_error(self, tmp_path: Path):
        ...
        with pytest.raises(DatureConfigError) as exc_info:
            load(Source(file=toml_file, loader=Toml10Loader), schema=Config)
